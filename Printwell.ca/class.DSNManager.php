...
class DSNManager {
        ...
        foreach($roles as $role_name=>$role_arr) {
                ...
                <div class='meta_item'>" . $this->get_checkbox("admin_notice",__("Admin notice", DSNMANAGER_TEXTDOMAIN),'child_check',true) . "</div>                <div class='meta_item'>" . $this->get_checkbox("dashboard_widget",__("Dashboard widget", DSNMANAGER_TEXTDOMAIN),'child_check',true) . "</div>
